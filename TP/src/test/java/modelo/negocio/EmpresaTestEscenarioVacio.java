...
//----- Metodo void agregarCliente(String usuario, String pass, String nombreReal)				    
    ...
    public void testAgregarCliente_ClaseCorrecta() {
        try {
            escenarioVacio.empresa.agregarCliente("user1", "pass123", "Gian");
...
//----- Metodo void agregarPedido(Pedido pedido)				   
    ...
    // testPedido_ClaseCorrecta() Escenario3
...
//----- Metodo Metodo ArrayList<Vehiculo> vehiculosOrdenadosPorPedido(Pedido pedido)				
    ...
    //public void testVehiculosOrdenadosPorPedido_ClaseCorrecta() Escenario3
        
    // Clases cubiertas: 1, 4 
    // testVehiculosOrdenadosPorPedido_SinVehiculosHabilitados() Escenario3
...
//----- Metodo void crearViaje(Pedido pedido, Chofer chofer, Vehiculo vehiculo)					    
    ...
    // testCrearViaje_ClaseCorrecta() Escenario4

    // Clases cubiertas: 1, 4, 5, 9 
    // testCrearViaje_PedidoNoRegistrado() Escenario3

    // Clases cubiertas: 1, 3, 6, 9
    // testCrearViaje_ChoferNoDisponible() Escenario4

    // Clases cubiertas: 1, 3, 5, 7, 10
    // testCrearViaje_VehiculoNoDisponible() Escenario4
       
    // Clases cubiertas: 1, 3, 5, 7, 9, 13, 14
    // testCrearViaje_VehiculoNoValido() Escenario4

    // Clases cubiertas: 1, 3, 5, 7, 9, 13, 15, 16
    // testCrearViaje_ClienteConViajePendiente() Escenario5

//----- Metodo void pagarYFinalizarViaje(int calificacion)				
    
    // Clases cubiertas: 1, 3 
    // testPagarYFinalizarViaje_Calificacion5() Escenario5

    // Clases cubiertas: 1, 3 
    // testPagarYFinalizarViaje_Calificacion0() Escenario5

    // Clases cubiertas: 1, 3 
    // testPagarYFinalizarViaje_Calificacion3() Escenario5
    
    // Clases cubiertas: 2, 3 
    // testPagarYFinalizarViaje_SinViajePendiente() {
    

//----- Metodo Usuario login(String usserName, String pass)				
    
    // Clases cubiertas: 1, 3, 5, 7 
    // testLogin_ClaseCorrecta() Escenario2
...
//----- Metodo ArrayList<Viaje> getHistorialViajeCliente(Cliente cliente)				
    ...
    // Clases cubiertas: 1, 3, 5 
    // testGetHistorialViajeCliente_ConHistorial() Escenario6

    // Clases cubiertas: 1, 4, 5 
    // testGetHistorialViajeCliente_SinHistorial() Escenario6

    // Clases cubiertas: 1, 3, 6 
    // testGetHistorialViajeCliente_ClienteNoRegistrado() Escenario6

//----- Metodo ArrayList<Viaje> getHistorialViajeChofer(Chofer chofer)				
    
    // Clases cubiertas: 1, 3, 5 
    // testGetHistorialViajeChofer_ConHistorial() Escenario6
    
    // Clases cubiertas: 1, 4, 5 
    // testGetHistorialViajeChofer_SinHistorial() Escenario6
    
    // Clases cubiertas: 1, 3, 6 
    // testGetHistorialViajeChofer_ChoferNoRegistrado() Escenario6
    
//----- Metodo double calificacionDeChofer(Chofer chofer)				   
    
    // Clases cubiertas: 1, 3, 5 
    // testCalificacionDeChofer_ChoferConTresViajes() Escenario6

    // Clases cubiertas: 1, 3, 5 
    // testCalificacionDeChofer_ChoferConUnViaje() Escenario6

    // Clases cubiertas: 1, 4 
    // testCalificacionDeChofer_ChoferSinViajes() Escenario6

//----- Metodo Metodo Pedido getPedidoDeCliente(Cliente cliente)				
    
    // Clases cubiertas: 1, 3 
    // testGetPedidoDeCliente_ClienteConPedidoEnCurso() Escenario4
    
    // Clases cubiertas: 1, 4 
    // testGetPedidoDeCliente_ClienteSinPedidoPendiente() Escenario4
    
//----- Metodo  Viaje getViajeDeCliente(Cliente cliente)					
    
    // Clases cubiertas: 1, 3 
    // testGetViajeDeCliente_ClienteConViajeEnCurso() Escenario5

    // Clases cubiertas: 1, 4 
    // testGetViajeDeCliente_ClienteSinViajeEnCurso() Escenario5
}
